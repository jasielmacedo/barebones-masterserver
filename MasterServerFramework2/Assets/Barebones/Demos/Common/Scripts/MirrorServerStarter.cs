...
public class MirrorServerStarter : MonoBehaviour
{
    ...
    public BmLogger Logger = Msf.Create.Logger(typeof(MirrorServerStarter).Name);
    ...
    protected virtual void StartSpawned()
    {
        Msf.Server.Spawners.RegisterSpawnedProcess(Msf.Args.SpawnId, Msf.Args.SpawnCode, (controller, error) =>
        {
            ...
            MirrorGameRoom.SpawnTaskController = controller;
