...
public class MirrorGameTerminator : MonoBehaviour
{
    ...
    private void OnPlayerJoined(NetMsfPlayer obj)
    {
        _hasFirstPlayerShowedUp = true;
    }

    private void OnPlayerLeft(NetMsfPlayer obj)
    {
